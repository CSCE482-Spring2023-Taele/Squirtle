...
def genSoundFromImage(file, output="sound.wav", duration=1.0, sampleRate=44100.0, intensityFactor=1, min_freq=0, max_freq=22000, invert=False, contrast=True, highpass=True, verbose=False):
